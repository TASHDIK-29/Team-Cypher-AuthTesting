    ...
    return <>
        <div className="flex items-center justify-center p-6">
            <div className="w-full max-w-sm relative">
                { }
                <div ref={cardRef} className="relative bg-white dark:bg-black border border-border rounded-lg p-6 shadow-sm transition-all duration-200 hover:shadow-md">
                    { }
                    ...
                    <div className="space-y-4">
                        ...
                        { }
                        <div className="space-y-2">
                            <FloatingLabelInput id="password" type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="Password" icon={<LockIcon />} rightIcon={showPassword ? <EyeOffIcon /> : <EyeIcon />} onRightIconClick={togglePasswordVisibility} />
                        </div>
                    ...
                    <div className="mt-6 text-center text-sm">
                        <span className="text-muted-foreground">
                            ...
                            <a onClick={() => navigate('/register')} className="underline underline-offset-4 hover:text-primary transition-colors cursor-pointer">
                                Sign up
                            </a>
                        </span>
                    </div>
